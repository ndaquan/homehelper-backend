...
CREATE TABLE Bookings (
    ...
    booking_time DATETIME2(7) NULL DEFAULT SYSUTCDATETIME(),
...
CREATE TABLE PostLikes (
    ...
    post_id INT,
    user_id INT,
    liked_at DATETIME2 DEFAULT SYSUTCDATETIME(),
...
CREATE TABLE VideoModerations (
    ...
    moderated_at DATETIME2 NOT NULL DEFAULT SYSUTCDATETIME(),
...
CREATE TABLE UserBadges (
    ...
    earned_at DATETIME NOT NULL DEFAULT SYSUTCDATETIME(),
